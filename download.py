...
useremail = "hoangtk13clc@gmail.com"
password = "x$$$"
...
def main():
    ...
    for filename,md5 in download_files.items():
        api_url = f'https://o9k5xn5546.execute-api.us-east-1.amazonaws.com/v1/archives/v1.0-mini/{filename}?region={region}&project=nuScenes'
